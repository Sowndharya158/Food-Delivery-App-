...
function handleHome(){
    ...
    return (
        <>
            <Header content="Secure Checkout" handleHome={handleHome}/>
            <main className='checkout'>
                <section className='checkout-info'>
                    ...
                    <form id='checkout-form'>
                        ...
                        {/* Delivery Details */}
                        <h3 style={{ margin: "1rem 0", fontWeight: "600" }}>Delivery Details</h3>
                ...
                <section className='cart-section'>
                    <div className="container">
                        <h3 style={{ color: "#A06C23", textAlign: "center" }}>Order Summary</h3>
                        ...
                        <div className='total'>
                            <h3><b>Sub Total:</b></h3>
                            <h3><b>${(Cart_total+deliveryfee+platformfee).toFixed(2)}</b></h3>
                        </div>
                            </div>
